 ...
 */
final class Version20221010155942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parse_url ADD CONSTRAINT FK_3521B24688CCE813 FOREIGN KEY (parse_url_id) REFERENCES url_checked (id)');
