 ...
 */
final class Version20221010155811 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parse_url ADD CONSTRAINT FK_3521B24688CCE813 FOREIGN KEY (parse_url_id) REFERENCES parse_url (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
