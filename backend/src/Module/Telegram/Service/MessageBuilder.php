...
class MessageBuilder
{
    ...
    public static function sendStartMessage(int $chatId)
    {
        ...
        $text[] = "";
        $text[] = '📹 <b><a href="https://youtu.be/WwiH4vB7gek"> Видео-инструкция по использованию бота</a></b>';
        $text[] = '📹 <b><a href="https://youtube.com/shorts/C8PB09GaXiE?feature=share"> Видео-инструкция как купить подписку</a></b>';
        $text[] = '';
        $text[] = '💬 <b><a href="https://trite-jackrabbit-ce3.notion.site/bibi-839950d75f7c49efaf7ef1aef1347e30">Текстовая-инструкция по использованию бота</a></b>';
        $text[] = '💬 <b><a href="https://trite-jackrabbit-ce3.notion.site/bibi-ad9eeb35c5ef4a8bbea011b51de70d70">Текстовая-инструкция как купить подписку</a></b>';
        $text = implode(PHP_EOL, $text);
...
//        ]);
    ...
    public static function sendExampleAds(int $chatId, )
    {

        $text = [];
        $text[] = "<b>⚠️ Это пример того, какие сообщения вам буду приходить, когда по вашему фильтру появится новое объявление</b>";
        $text[] = "";
        $text[] = "<b>🚨Новое объявление🚨</b>";
        $text[] = "";
        $text[] = "🚗<b>Имя</b>: Hyundai Elantra, 2002";
        $text[] = "💰<b>Цена</b>: 180 000";
        $text[] = "📖<b>Описание</b>: 223 587 км, 2.0 AT (139 л.с.), седан, передний, бензин";
        $text[] = "🌆<b>Город</b>: Ивантеевка";
        $text[] = "📁<b>Имя фильтра</b>: Москва элантра до 240к";

        $text = implode(PHP_EOL, $text);

        $ad = [];
        $ad['text'] = 'Объявление 🚘';
        $ad['url'] = 'https://avito.ru/';

        $filter = [];
        $filter['text'] = 'Фильтр 🛠';
        $filter['url'] = 'https://avito.ru/';
